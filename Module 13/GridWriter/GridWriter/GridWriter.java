/* Original version provided by Jason Schatz, downloadable from CCSF Insight
   Modifications by Nestor Alvarez
   20160503
 */
...
public class GridWriter {
   ...
   public GridItem get(int index) throws IndexOutOfBoundsException {
      if (index >= size || index < 0) {
         throw new IndexOutOfBoundsException("Searchable Index is Larger than the array");
      }
      return items[index];
   }
